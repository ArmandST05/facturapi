              ...
              <?php if ((isset($_SESSION["user_id"])) && ($_SESSION['typeUser'] == "su")) : ?>
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li><a href="./?view=medic-categories/index">Especialidades</span></a></li>
                    <li><a href="./?view=satisfaction-survey/index">Encuesta de satisfacción</a></li>
                    <!--<li><a href="./?view=laboratories/index">Espacios</a></li>-->
