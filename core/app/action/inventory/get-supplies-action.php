...
$sql = "SELECT id, name, type_id,minimum_inventory FROM products WHERE type_id='3' AND is_active = '1'";
...
while ($row = mysqli_fetch_array($query)) {  // preparing an array
    $nestedData = array();
    $quantity = OperationDetailData::getStockByProduct($row["id"]);
    ...
    $nestedData[] =  '<td >
    <a href="index.php?view=inventory/input-supply&id=' . $row["id"] . '" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-plus-sign"></i>Entrada</a>
