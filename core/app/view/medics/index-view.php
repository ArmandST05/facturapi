				...
				<?php foreach ($medics as $medic) : ?>
					<tr>
						...
						<td style="width:180px;">
							...
							<a href='index.php?action=medics/update-status&id=<?php echo $medic->id ?>&isActive=0' class='btn btn-danger btn-xs' onClick='return confirmDelete()'><i class="fas fa-trash"></i>Eliminar</a>
						</td>
					</tr>
					<?php
					?>
