...
if (!$patient) {
    echo "<script> 
          alert('El paciente de la cita no existe');
          window.location.href = './?view=home';
        </script>";
}
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    ...
                    <a href='./?view=sales/new-details&reservationId=<?php echo $_GET["id"] ?>&patientId=<?php echo $reservation->patient_id ?>&medicId=<?php echo $reservation->medic_id; ?>&date=<?php echo date("Y-m-d H:i:s"); ?>' class='btn btn-primary btn-xs'><i class="fas fa-dollar-sign"></i> Realizar Venta</a>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <b>Agendado por: </b><?php echo $reservation->getUser()->name ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <b>Espacio: </b><?php echo $reservation->getLaboratory()->name ?>
                    </div>
                    <div class="col-md-3">
        ...
        <div id="medicalConsultationDetails">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title" id="titleSatisfactionSurvey"><?php echo ($reservation->is_finished) ? "Encuesta de satisfacción" : "" ?></h3>
                    <div class="box-tools pull-right">
                        <?php if (!$reservation->is_finished) : ?>
                            <button id="btnFinishReservation" onclick="finishReservation()" class='btn btn-warning btn-sm'>Finalizar consulta</button>
                        <?php endif; ?>
                        <button type="button" class="btn btn-box-tool" data-widget="collapse">
                            <i class="fa fa-minus"></i>
                        </button>
                ...
                <div class="box-body">
                    <div class="row">
                        <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="index.php?action=satisfaction-survey/update-reservation" role="form">
                            <div class="col-md-12" id="detailSatisfactionSurvey">
...
<script>
    ...
    $(document).ready(function() {
        ...
        //Consulta finalizada
        if (<?php echo $reservation->is_finished ?> == 1) {
    ...
    function finishReservation() {
        updateFinishReservation();
    }

    function updateFinishReservation() {
        $.ajax({
            url: "./?action=reservations/update-finished-reservation", // json datasource
            type: "POST", // method, by default get
            data: {
                reservationId: "<?php echo $reservationId; ?>",
                isFinished: 1
            ...
            success: function(data) {
                Toast.fire({
                    icon: 'success',
                    title: 'Se marcó como finalizada la consulta.'
                });
                $("#btnFinishReservation").hide();
                loadSatisfactionSurvey();
            },
            error: function() { // error handling
                Toast.fire({
    ...
    function loadSatisfactionSurvey() {
        $.ajax({
            url: "./?action=satisfaction-survey/get-reservation-questions", // json datasource
            type: "GET", // method, by default get
            data: {
                reservationId: "<?php echo $reservationId; ?>"
            },
            success: function(data) {
                $("#titleSatisfactionSurvey").text("Encuesta de satisfacción");
                $("#detailSatisfactionSurvey").html(data);
                console.log(data);
            },
            error: function() { // error handling
