				...
				?>
					<tr>
						...
						<td style="width:80px;" class="td-actions">
							...
							<a href='index.php?action=income-concepts/update-status&id=<?php echo $concept->id ?>&isActive=0' class='btn btn-danger btn-xs' onClick='return confirmDelete()'><i class="fas fa-trash"></i></a>
						</td>
					</tr>
				<?php
