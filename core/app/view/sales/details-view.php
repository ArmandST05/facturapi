<?php
print "<script>window.open('index.php?action=sales/details-print&id=".$_GET['id']."');
</script>";
?>
...
<?php if (isset($_GET["id"]) && $_GET["id"] != "") : 
	...
	<br><br>
	<?php $realTotal = ($total - $sale->discount);?>
	<div class="row">
		<div class="col-md-4">
			<table class="table table-bordered">
				<tr>
					...
					<td>
						<h4>$ <?php echo number_format(($realTotal-($realTotal*.16)), 2, '.', ','); ?></h4>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<h4>$ <?php echo number_format(($realTotal*.16), 2, '.', ','); ?></h4>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<h4>$ <?php echo number_format(($realTotal), 2, '.', ','); ?></h4>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<h4>$ <?php echo number_format(($realTotal) - $totalPay, 2, '.', ','); ?></h4>
					</td>
				</tr>
			</table>
		</div>
