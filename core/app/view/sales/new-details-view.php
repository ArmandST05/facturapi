...
$products = array_merge(ProductData::getAllByTypeId(4)); //Insumos, Medicamentos y conceptos ingresos para venta ProductData::getAllByTypeId(3), ProductData::getAllByTypeId(4), ProductData::getAllByTypeId(1)
...
if ($reservationId && !isset($_SESSION["cart"])) {
  ...
  if (substr($date, 0, 10) < substr($reservationData->date_at, 0, 10)) {
    ...
    <div class="form-group">
      ...
      <div class="col-lg-2">
        ...
        <div class="input-group">
          ...
          <input type="number" step="any" class="form-control" autofocus name="price" id="price" required placeholder="Costo" <?php echo ($_SESSION['typeUser'] == "su") ?"":"readonly"?>>
        </div>
      </div>
      <div class="col-lg-2">
            ...
            <tr>
              ...
              <td>
                <form method="POST" action="index.php?action=sales/add-cart-discount" autocomplete="off">
                  <div class="col-md-6">
                    <input type="number" id="discountSale" name="discountSale" class="form-control" value="<?php echo $discountPercentage ?>" min="0" max="100" <?php echo ($userType == "su") ? "" : "disabled" ?>>
                    <input type="hidden" id="patientId" name="patientId" value="<?php echo $patientId ?>" class="form-control">
                    <input type="hidden" id="date" name="date" value="<?php echo $date ?>" class="form-control">
                  </div>
                  <?php if ($userType == "su") : ?>
